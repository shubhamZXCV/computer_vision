...
train_and_evaluate(model_std, train_loader, val_loader, test_loader, "standard_resnet18")
...
train_and_evaluate(model_pre, train_loader, val_loader, test_loader, "pretrained_resnet18")